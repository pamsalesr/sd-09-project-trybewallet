...
import getCurrencyApi from '../service/currencyApi';
import { addNewExpense, setExpenseValue, setTotalValue } from '../actions';
...
const mapDispatchToProps = (dispach) => ({
  sendNewExpenseObj: (expenseObj) => dispach(addNewExpense(expenseObj)),
